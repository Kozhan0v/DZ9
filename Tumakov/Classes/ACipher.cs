        ...
        public string Encode(string text)
        {
            ...
            for (int i = 0; i < text.Length; i++)
            {
                if (char.IsUpper(charText[i]))
                {
                    ...
                    if (indexOfSymb == 32)
                    {
                        charText[i] = _upperAlphabet[0];
                    }
                    else
                    {
                        charText[i] = _upperAlphabet[indexOfSymb + 1];
                    }
                }
                else if (char.IsLower(charText[i]))
                {
                    ...
                    if (indexOfSymb == 32)
                    {
                        charText[i] = _lowerAlphabet[0];
                    }
                    else
                    {
                        charText[i] = _lowerAlphabet[indexOfSymb + 1];
                    }
                }
                else
                {
